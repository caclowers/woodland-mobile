    ...
    return (
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.container}>
          ...
          <Text style={styles.name}>
            Garlic Bread (5 pc): $4.50  (2 pc): $2.50
          </Text>
          <Text style={styles.name}>
            Cheesy Garlic Bread (5 pc): $5.50  (2 pc):$3.50
          </Text>
          <Text style={styles.name}>
          ...
          <Text style={styles.name}>
            12 inch Giant Cookie - 8.00
          </Text>
          <Text>
            Chocolate Chip...Enough to satisfy any sweet tooth
          </Text>
          <Text style={styles.name}>
            Fresh Cookie Dough - 4.50
          </Text>
          <Text>
            Chocolate Chip...Ready To Bake When You Want'Em!
          </Text>
